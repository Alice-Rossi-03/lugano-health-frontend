        ...
        <div>
            ...
            <div class="d-flex flex-wrap w-100 justify-content-center mt-4 gap-3">
                ...
                <div class="card border border-success d-green-bg" style="width: 18rem;">
                    <svg class="mx-auto mt-4" fill="gold" height="100px" width="100px"
                    ...
                    <div class="card-body d-flex align-items-center p-3 px-4">
                        <h5 class="card-title text-center text-white">Cerca tra migliaia di dottori in base alla
                            specializzazione. <br>
                ...
                <div class="card border border-success d-green-bg" style="width: 18rem;">
                    ...
                    <div class="card-body d-flex align-items-center p-3 px-4">
                        <h5 class="card-title text-center text-white">Confronta i risultati e le recensioni lasciate da
                            altri utenti</h5>
                    </div>
                </div>
                ...
                <div class="card border border-success d-green-bg" style="width: 18rem;">
                    ...
                    <div class="card-body d-flex align-items-center p-3 px-4">
                        <h5 class="card-title text-center text-white">Contatta il medico per accertartarti della sua
                            disponibilità. <br>
